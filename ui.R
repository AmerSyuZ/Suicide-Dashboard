...
#header---------------------------------------------------------------------------
header <-
    dashboardHeader(title = "SUICIDE DASHBOARD",
                    titleWidth = 400)
        ...
        tabItem(
            ...
            fluidRow(
                box(
                    ...
                    valueBoxOutput(outputId = "total_suicide", width = 3),
...
tabItem(
    ...
    fluidRow(
        box(
            title="Suicides Rates by Age and Gender",
            width = 12,
...
tabItem(
    ...
    fluidRow(
        ...
        box(
            ...
            height = "920px",
            plotlyOutput(outputId = "suicidemap",width="100%",height="700px" )
